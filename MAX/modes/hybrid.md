...
Hybrid Mode is the recommended default for ordinary feature work.

It keeps Spec and Task planning sequential while allowing limited parallel execution only where scopes are independent.
